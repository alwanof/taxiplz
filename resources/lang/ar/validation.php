...
return [
    ...
    */
    ...
    'active_url' => 'السمة: ليست عنوان صالحًا',
    ...
    'different' => 'يجب أن تكون السمة: و: الأخرى مختلفة.',
    ...
    'min' => [
        'numeric' => 'يجب أن تكون السمة: على الأقل: الحد الأدنى',
        'file' => 'يجب أن تكون السمة: على الأقل: دقيقة كيلوبايت.',
        'string' => 'يجب أن تكون السمة على الأقل: الحد الأدنى من الأحرف.',
