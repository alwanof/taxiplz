...
Parse.initialize(
    "NqwKQLRjvORNCns4fVHZy6jP8HaWDB2zf6X6l9JW",
    "bSjcbfvOmfq9NpTrEYhraRWrddOTlvhA4jWXiLru"
);
...
Vue.component(
    "drivers",
    require("./components/app/DriversComponent.vue").default
);
Vue.component("order", require("./components/app/OrderComponent.vue").default);
Vue.component(
    "notification",
    require("./components/app/NotificationComponent.vue").default
);
Vue.component(
    "members-sheet",
...
// cd /home/narabana.com/public_html
